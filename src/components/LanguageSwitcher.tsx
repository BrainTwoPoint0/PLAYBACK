...
// readable no matter which locale the page is currently in.
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          aria-expanded={open}
          className={cn(
            'inline-flex items-center gap-2 rounded-md text-sm text-[var(--ash-grey)]',
            'hover:text-[var(--timberwolf)] transition-colors',
      ...
      <PopoverContent
        align="end"
        className="w-40 bg-[var(--night)] border-[var(--ash-grey)]/30 p-1"
      >
          ...
          <button
            ...
            className={cn(
              ...
              l === current
                ...
                : 'text-[var(--ash-grey)] hover:text-[var(--timberwolf)] hover:bg-white/5'
            )}
          >
            {LOCALE_NAMES[l]}
