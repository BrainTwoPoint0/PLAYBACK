...
export default function LoginPage() {
    ...
    return (
        <div
            className="md:my-36 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-neutral-800/70 backdrop-blur-xl border border-neutral-700/60 rounded-2xl shadow-2xl p-8 space-y-8">
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="text-3xl font-bold mb-2" style={{ color: 'var(--timberwolf)' }}>Welcome back</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3">
                            <Label htmlFor="email" className="font-medium" style={{ color: 'var(--timberwolf)' }}>Email address</Label>
                        ...
                        {/* Password Field */}
                        <div className="space-y-3">
                            <Label htmlFor="password" className="font-medium" style={{ color: 'var(--timberwolf)' }}>Password</Label>
                            <div className="relative">
                                <Input
                                    id="password"
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-neutral-800 px-4 font-medium" style={{ color: 'var(--ash-grey)' }}>
                                or continue with
                            </span>
                        </div>
                    </div>
