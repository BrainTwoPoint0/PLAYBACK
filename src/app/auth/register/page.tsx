...
import { validateEmail, validatePassword, validateUsername, getAuthErrorMessage } from '@/lib/auth/shared'
                ...
                <div className="bg-neutral-800/70 backdrop-blur-xl border border-neutral-700/60 rounded-2xl shadow-2xl p-8 space-y-8">
                    ...
                    <div className="text-center">
                        <div className="flex justify-center mb-6">
                            ...
                            >
                                <span className="text-3xl font-bold" style={{ color: 'var(--night)' }}>PB</span>
                            </div>
                        </div>
                        <h1 className="text-3xl font-bold mb-2" style={{ color: 'var(--timberwolf)' }}>Create account</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-3">
                            <Label htmlFor="fullName" className="font-medium" style={{ color: 'var(--timberwolf)' }}>
                                Full name
                            </Label>
                            <Input
                                id="fullName"
                                ...
                                style={{ color: 'var(--timberwolf)', borderColor: 'var(--ash-grey)', paddingLeft: '12px' }}
                                disabled={loading}
                                autoComplete="name"
                            />
                        </div>
                        ...
                        {/* Username */}
                        <div className="space-y-3">
                            <Label htmlFor="username" className="font-medium" style={{ color: 'var(--timberwolf)' }}>
                                Username
                            </Label>
                            <Input
                                id="username"
                        ...
                        {/* Email */}
                        <div className="space-y-3">
                            <Label htmlFor="email" className="font-medium" style={{ color: 'var(--timberwolf)' }}>
                                Email address
                            </Label>
                            <div className="relative">
                                <Input
                                    ...
                                    style={{ color: 'var(--timberwolf)', borderColor: 'var(--ash-grey)' }}
                                    disabled={loading}
                                    autoComplete="email"
                                />
                                <Mail className="h-5 w-5 absolute left-4 top-3.5" style={{ color: 'var(--ash-grey)' }} />
                            </div>
                        </div>

                        {/* Password */}
                        <div className="space-y-3">
                            <Label htmlFor="password" className="font-medium" style={{ color: 'var(--timberwolf)' }}>
                                Password
                            </Label>
                            <div className="relative">
                                <Input
                                ...
                                />
                                <Lock className="h-5 w-5 absolute left-4 top-3.5" style={{ color: 'var(--ash-grey)' }} />
                            </div>
                        </div>

                        {/* Confirm Password */}
                        <div className="space-y-3">
                            <Label htmlFor="confirmPassword" className="font-medium" style={{ color: 'var(--timberwolf)' }}>
                                Confirm password
                            </Label>
                            <div className="relative">
                                <Input
